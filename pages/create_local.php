...
<body>
	...
	<div class="wrapper">
		...
		<div class="header">
			<div class="container">
				<!-- Logo -->
				<a class="logo" href="index.html"> <img src="assets/img/logo2.png"
					alt="Logo">
				</a>
				<!-- End Logo -->
				<!-- Topbar -->
			...
			<div
				...
				<div class="container">
					<ul class="nav navbar-nav">
						<!-- Home -->
						<li class=""><a href="index.html" class="" data-toggle=""> Home </a></li>
						<li class=""><a href="car_search.html" class="" data-toggle="">
								Fleet </a></li>
						<!-- End Home -->
						...
						<li class="dropdown active"><a href="javascript:void(0);"
							...
							<ul class="dropdown-menu">
								<li class="active"><a href="create_local.html">Create Location</a></li>
						...
						<li class="dropdown "><a href="javascript:void(0);"
							class="dropdown-toggle" data-toggle="dropdown"
							onclick="window.location = 'administration.html'"> Administration
						</a>
							<ul class="dropdown-menu">
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-3 md-margin-bottom-40">
							<a href="index-2.html"><img id="logo-footer" class="footer-logo"
								src="assets/img/logo2.png" alt=""></a>
							<p>O minja é o pior Nasus e consegue feedar em todos os jogos. O
								Zé é sombrio e isso faz com que ele não saia de silver.</p>
						</div>
						<!--/col-md-3-->
						<!-- End About -->
						...
						<div class="col-md-3 map-img md-margin-bottom-40">
							...
							<address class="md-margin-bottom-40">
								Rua dos feeders <br /> Porto Portugal <br /> Phone: f33d f33d
								f33d <br /> Email: <a href="" class="">feeders@feeders.com</a>
							</address>
						</div>
						<!--/col-md-3-->
						<!-- End Address -->
